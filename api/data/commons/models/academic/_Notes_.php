...
abstract class _Notes_ extends Data
{
    protected $id = 0, $session = 0, $_etudiant = 0, $_cours = 0, $_annee_academique = 0;
    protected $note = 0.0;
    protected $annee_academique = null;
    protected $etudiant = null;
    protected $cours = null;
    public static $list = [];
    ...
    public static function fetchAll($override = false){
        ...
        self::$list = [];
        $db = Storage::Connect();
        $chk = $db->prepare("select * from notes where version > :p98");
        try{
